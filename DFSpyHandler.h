...
#include "/Users/ChristianHaroldNunez/Desktop/ftkcommon/ftkcommon/SourceIDSpyBuffer.h"
#include "/Users/ChristianHaroldNunez/Desktop/ftkcommon/ftkcommon/SpyBuffer.h"
...
private:
    ...
    std::map<int, std::tuple<int, int> > mapROBIDtoBoardAndLane(std::string multiboard);
    std::map<std::tuple<int, int>, std::set<int> > mapBoardAndLaneToModIDsInspy(std::string moduleListFile);
    std::map<std::tuple<int, int>, std::tuple<int, int> > mapTowerPlaneToBoardLane(std::string sysFile);
    std::map<std::tuple<int, int>, std::set<int> > mapBoardAndLaneModIDsOutspy(std::string moduleListFile);
    std::map<int, std::set< std::tuple<int, int> > > mapModID2BoardAndLaneOutspy();
    ...
    std::map<int, std::tuple<int, int> > ROBIDtoBoardAndLane;
